...
const LogIn = ({isActive, dispatch}) => (
  <Wrapper 
    style={{background: '#222'}} 
    thisMenu='login' 
    active={isActive}
    onClick={() => dispatch(selectMenu('login'))}>
    { 
      isActive 
...
const LogInIcon = ({iconStyle}) => (
  <div>
    <svg style={iconStyle} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
      <path d="M250,34C130.706,34,34,130.706,34,250s96.706,216,216,216s216-96.706,216-216S369.294,34,250,34z M388.593,388.593
      ...
      c23.337,9.871,44.3,24.006,62.307,42.013c18.007,18.007,32.142,38.97,42.013,62.307C440.821,197.865,446,223.531,446,250
      c0,26.469-5.179,52.135-15.394,76.286C420.735,349.623,406.6,370.586,388.593,388.593z"/>
    </svg>
...
const mapState = state => ({
  isActive: state.activeMenu === 'login'
})
